...
Axiom o_associative : forall( A B C : E), (o A (o B C)) = (o (o A B) C).
(* e est neutre à gauche pour o *)
Axiom e_neutral_left : forall (A : E), (o e A) = A.

(* e est neutre à droite pour o *)
Axiom e_neutral_right : forall (A : E),(o A e) = A.
